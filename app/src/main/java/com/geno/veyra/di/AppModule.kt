...
import com.geno.veyra.BuildConfig
import com.geno.veyra.glasses.GlassesBackend
import com.geno.veyra.glasses.mock.MockGlassesBackend
import com.geno.veyra.tools.VisionBridge
import com.geno.veyra.tools.VisionController
import com.geno.veyra.wakeword.VoskWakeWordEngine
...
object AppModule {
    ...
    fun glassesBackend(@ApplicationContext context: Context): GlassesBackend {
        ...
        return runCatching {
            val cls = Class.forName("com.geno.veyra.glasses.real.RealGlassesBackend")
